...
class  NavigationRoute extends Component {
  ...
  const sectorDes = [
    ...
    {name: 'Banking', value: 'This section surveys banks licensed by the Bank of Ghana'},
    {name: 'Telecommunications', value: 'This section surveys licensed Telecom companies in Ghana'},
    {name: 'Hospitality', value: 'This section surveys hotels that are regulated by the Ghana Tourism Authority' },
    {name: 'Retail Malls', value: 'This section surveys major retail outlets in Ghana' },
    {name: 'Public Institutions', value: 'This section surveys public sector institutions in Ghana'},
